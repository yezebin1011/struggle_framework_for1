...
<html>
   <head>
	  ...
	  <script type="text/javascript" src="webpage/base/module/js/list.js"></script>
   </head>
   
   <body style="margin:0px;">
      <div id="moduleAdd" class="easyui-window" 
                           title="模块管理"
                           closed="true" 
                           style="width:600px;height:300px;"
                           data-options="onClose:function(){$('#moduleAdd').empty();}">
     </div>
